...
/**
 * ducanh
 * Tao ajax table cho sub table trong table
 * @param {type} obj
 * @returns {undefined}
 */
function creat_ajax_table2(obj) {
...
function creat_ajax_table(obj) {
    ...
    $.ajax({
        ...
        success: function(dataAll) {
            ...
            // ducanh
            // table trong table
            $(".e_data_table2").each(function() {
                creat_ajax_table2($(this));
            });
            
            /**
             * Mac dinh ban dau minizim het sub table
             * @param {type} param
             */
            $(".e_toogle").each(function() {
                $(this).click();
            });
        },
        error: function(a, b, c) {
