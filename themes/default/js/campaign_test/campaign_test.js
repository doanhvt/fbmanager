                ...
                if (data.list_campaign_landingpage) {
                    $.each(data.list_campaign_landingpage, function(i) {
                        if (data.list_campaign_landingpage[i]['info_campain_landingpage']) {
                            ...
                            addString += "<input " + status + " name='edit_code_chanel[]' type='hidden'  class='e_input' type='hidden' value='" + data.list_campaign_landingpage[i]['info_campain_landingpage']['code_chanel'] + "'/>";
                            addString += "</td>";
                            //===================================
                            addString += "<td>";
                            ...
                            addString += '<input ' + status + ' type="hidden" id="e_status" class="e_input" name="edit_status[]" value="' + data.list_campaign_landingpage[i]['info_campain_landingpage']['status'] + '"/>';
                            ...
                            //===================================
                            var addString = "<td>";
                            addString += "<select " + status + " class='select2 e_change_value e_landingpage e_change e_input' name='id_landingpage[]'>";
                            $.each(data.list_landingpage, function(x) {
                                addString += "<option url='" + data.list_landingpage[x]['url'] + "/' value='" + data.list_landingpage[x]['id'] + "'>" + data.list_landingpage[x]['name'] + "</option>";
                            });
                            addString += "</select>";
                            ...
                            addString += "<input " + status + " name='code_chanel[]' type='hidden'  class='e_input' value='" + data.list_campaign_landingpage[i]['code'] + "'/>";
                            addString += "</td>";
                            //===================================
                            addString += "<td>";
