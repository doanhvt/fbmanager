                        ...
                        <?php if (count($item_record->list_ads) > 1) { ?>
                            <?php if ($key == "_sum_"): ?>
                                <tr class="gradeX" id="i_<?php echo $key_chanel; ?>" style="">
                                    <td class="e_chosse_day e_minimize" date='<?php echo $key_chanel; ?>' style="white-space: nowrap;cursor: pointer"><?php echo $item_record->stt; ?></td>
                                    <td class="e_chosse_day e_minimize" date='<?php echo $key_chanel; ?>' style="white-space: nowrap;cursor: pointer"><?php echo $item_record->name; ?></td>
                                <?php else: ?>
                                <tr class="gradeX e_tr_<?php echo $key_chanel; ?>" style="display: none">  
                                <?php endif; ?>  
                                <?php if ($i == 1) { ?>
                                    <td class="e_chosse_day e_maximize" date='<?php echo $key_chanel; ?>' style="white-space: nowrap;cursor: pointer" rowspan="<?php echo $count_ads; ?>"><?php echo $item_record->stt; ?></td>
                                    <td class="e_chosse_day e_maximize" date='<?php echo $key_chanel; ?>' style="white-space: nowrap;cursor: pointer" rowspan="<?php echo $count_ads; ?>"><?php echo $item_record->name; ?></td> 
                                <?php } ?>                              
