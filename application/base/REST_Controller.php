...
//        $controller = explode('/', $this->uri->uri_string());
        ...
        $this->rest->db->select();
        $this->rest->db->from(config_item('rest_access_table') . " as a");
        $this->rest->db->join(config_item('rest_keys_table') . " as k", "k.id=a.key_id");
        $this->rest->db->where('k.' . config_item('rest_key_column'), $this->rest->key);
