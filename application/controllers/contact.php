...
class contact extends manager_base {
    ...
    public function export_contact() {
        ...
        foreach ($data as $record_item) {
            ...
            $data_row->status_regis = $record_item->status_regis;
            if ($data_row->status_regis == '1') {
                $data_row->status_regis = 'yes';
            }
            if ($data_row->status_regis == '0') {
                $data_row->status_regis = 'No';
            }
        ...
        //Fill color header
        $sheet->getActiveSheet()->getStyle('A6:T6')->applyFromArray(
                array(
                    'fill' => array(
        ...
        $sheet->getActiveSheet()->getStyle('A6:T6')->getFont()->setBold(true)
                ->setName('Verdana')
                ->setSize(10)
        ...
        $sheet->getActiveSheet()->getColumnDimension('T')->setWidth(20);
